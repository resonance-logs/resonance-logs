<script lang="ts">
  ...
  $effect(() => {
    setBossOnlyDps(SETTINGS.live.general.state.bossOnlyDps);
  });
</script>
...
<Tabs.Content value={SETTINGS_CATEGORY}>
  ...
  <SettingsSlider bind:value={SETTINGS.live.general.state.resetElapsed} label="Reset after Elapsed Time" description="Amount of time to wait before the meter automatically resets the encounter. 0s = Never Resets"></SettingsSlider>
