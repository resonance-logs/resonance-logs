...
pub struct SyncContainerDirtyData {
    /// Raw bytes containing serialized CharSerialize data (BufferStream in game)
    #[prost(bytes = "vec", optional, tag = "1")]
    pub v_data: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
}
#[derive(specta::Type, Clone, PartialEq, ::prost::Message)]
...
pub struct SyncDungeonDirtyData {
    /// Raw bytes containing serialized DungeonSyncData data (BufferStream in game)
    #[prost(bytes = "vec", optional, tag = "1")]
    pub v_data: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
}
#[derive(specta::Type, Clone, PartialEq, ::prost::Message)]
